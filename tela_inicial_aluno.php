            ...
            <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img class="d-block w-100" src="Imagens/image19.svg" alt="primeiro slide">
                    </div>
                    <div class="carousel-item">
                        <img class="d-block seg w-100" src="Imagens/image20.svg" alt="segundo slide">
                    </div>
                </div>
        ...
        <div class="div-main">
            <section>
                <div>
                    ...
                    <h2>Matemática</h2>
                    <a href="visitar.php"><input type="button" id="button1" value="Aprender"></a>
                </div>
                <div>
                    <img src="imagens/portugues.png" alt="portugues">
                    <h2>Português</h2>
                    <a href="visitar.php"><input type="button" id="button2" value="Aprender"></a>
                </div>
            </section>
            <section>
                <div>
